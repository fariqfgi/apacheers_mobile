...
Color primaryColor = Color(0xffcc0000);
Color secondaryColor = Color(0xffED6363);
...
Color secondaryTextColor = Color.fromARGB(255, 0, 0, 0);
Color tertiaryTextColor = Color(0xff999999);
